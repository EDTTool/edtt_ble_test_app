...
static struct bt_gatt_attr service_b_3_1_attrs[] = {
    ...
    BT_GATT_CHARACTERISTIC(BT_UUID_VALUE_V6,
        BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE_WITHOUT_RESP | BT_GATT_CHRC_WRITE | BT_GATT_CHRC_NOTIFY,
        BT_GATT_PERM_READ | BT_GATT_PERM_WRITE,
        read_value_v6, write_value_v6, &value_v6_value, 0x51),
    BT_GATT_CCC(value_v6_ccc_cfg, value_v6_ccc_cfg_changed, 0x53)
};

static struct bt_gatt_service service_b_3_1_svc = BT_GATT_SERVICE(service_b_3_1_attrs);
...
void service_b_3_1_value_v6_notify(void)
{
    ...
    bt_gatt_notify(NULL, &service_b_3_1_attrs[1], &value_v6_value, sizeof(value_v6_value));
}
