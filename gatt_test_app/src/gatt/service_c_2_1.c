...
static u8_t   long_des_v2d1_value[] = {
	...
	0x56, 0x78, 0x90, 0x12, 0x34, 0x56, 0x78, 0x90, 0x11
};
...
static u8_t   long_des_v2d2_value[] = {
	0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0x00, 0x12, 0x34,
	0x56, 0x78, 0x90, 0x12, 0x34, 0x56, 0x78, 0x90, 0x11, 0x22
};
...
static struct bt_gatt_attr service_c_2_1_attrs[] = {
	BT_GATT_PRIMARY_SERVICE(BT_UUID_SERVICE_C_2, 0xC0),
	BT_GATT_CHARACTERISTIC(BT_UUID_VALUE_V10,
		BT_GATT_CHRC_READ,
		BT_GATT_PERM_READ,
	...
	BT_GATT_DESCRIPTOR(BT_UUID_LONG_DES_V2D2,
		BT_GATT_PERM_READ | BT_GATT_PERM_WRITE,
	...
	BT_GATT_DESCRIPTOR(BT_UUID_LONG_DES_V2D3,
		BT_GATT_PERM_READ | BT_GATT_PERM_WRITE,
