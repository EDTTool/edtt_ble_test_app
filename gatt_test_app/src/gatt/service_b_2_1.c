...
static struct bt_gatt_attr service_b_2_1_attrs[] = {
	BT_GATT_PRIMARY_SERVICE(BT_UUID_SERVICE_B_2, 0x70),
	...
	BT_GATT_CEP(&cha_ext_pro_value, 0x73),
	BT_GATT_CUD(cha_user_des_value, BT_GATT_PERM_READ, 0x74),
	BT_GATT_CPF(&cha_format_value, 0x75),
