...
static struct bt_gatt_service service_b_3_2_svc = BT_GATT_SERVICE(service_b_3_2_attrs);
...
void service_b_3_2_value_v6_notify(void)
{
    ...
    bt_gatt_notify(NULL, &service_b_3_2_attrs[1], &value_v6_value, sizeof(value_v6_value));
}
