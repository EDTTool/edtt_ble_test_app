...
static struct bt_gatt_attr service_a_1_attrs[] = {
	BT_GATT_PRIMARY_SERVICE(BT_UUID_SERVICE_A, 0x20),
	BT_GATT_INCLUDE_SERVICE(service_d_1_attrs, 0x21),
	BT_GATT_CHARACTERISTIC(BT_UUID_VALUE_V1,
		BT_GATT_CHRC_READ,
		BT_GATT_PERM_READ_ENCRYPT,
		read_value_v1, NULL, &value_v1_value, 0x22),
	BT_GATT_CHARACTERISTIC(BT_UUID_VALUE_V2,
	...
	BT_GATT_CHARACTERISTIC(BT_UUID_VALUE_V3,
		BT_GATT_CHRC_WRITE,
		BT_GATT_PERM_WRITE,
